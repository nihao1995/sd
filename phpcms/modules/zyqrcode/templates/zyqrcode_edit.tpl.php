				...
				<table width="100%" class="table_form" id="mytable">
					<tbody>
                        <tr>
                            ...
                            <td><input style="width: 50%;" type="text" name="project" id="project" class="input-text" required="" value="<?php echo $info['project']?>"></td>
                        </tr>
						<tr>
							<th width="125">APP名称</th>
						...
						<tr>
							...
							<td><input style="width: 50%;" type="text" name="url" id="url" class="input-text" required="" value="<?php echo $info['url']?>" /></td>
						</tr>
						<tr>
							<th>APP LOGO</th>
							<td>
						...
						<tr>
							<th>是否在前台显示</th>
							<td>
								<?php if($info['isshow']==1){ ?>
									<input type="checkbox" class="js-switch2" checked name="isshow" value="1" />
								<?php }else{?>
									<input type="checkbox" class="js-switch2" name="isshow" value="0" />
								<?php }?>
							</td>
						</tr>
						<script>
