...
<script>
    ...
    window.parent.app12 = new Vue({
        ...
        methods:{
            ...
            upload:function()
            {
                aj.post("index.php?m=zymanage&c=fileManage&a=addFileManage&pc_hash=<?php echo $_GET["pc_hash"]?>",{titlename:this.titlename, VFTID:this.VFTID, fileAddr:this.dataList},function(data){
                    if(data.code == 1)
                    {
