    ...
    aj.post("index.php?m=zymanage&c=rules&a=getData&pc_hash=<?php echo $_GET["pc_hash"]?>",{page:1},function(data){
        window.parent.app12 = new Vue({
            ...
            methods:{
                ...
                upload:function()
                {
                    aj.post("index.php?m=zymanage&c=rules&a=editFileManage&pc_hash=<?php echo $_GET["pc_hash"]?>",{titlename:this.titlename, fileAddr:this.dataList, RFID:this.RFID},function(data){
                        if(data.code == 1)
                        {
