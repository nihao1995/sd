                    ...
                    <tr >
                        ...
                        <th>
                            <v-select :options="iseliteData"  :multiple="false" :taggable="true"
                                      :close-on-select="true"  label="typename" @input="getelite" :value="selected2"
                            ></v-select>
                        </th>
                    </tr>
                    </tbody>
...
<script>
    ...
    window.parent.app12 = new Vue({
        ...
        data:{
            ...
            categoryoptions:[],
            category:'<?php echo $dataInfo["category"]; ?>',
            ...
            selected:'',
            selected2:'<?php if($dataInfo["iselite"] == 1) echo "是"; else echo "不是";  ?>',
            ...
            iselite:<?php echo $dataInfo["iselite"]; ?>,
            listStyle: {
                width: '500px',
                height: '500px'
            },
...
//                    console.log(that.getTransfer(data.data.fileData, "F"));
            ...
            upload:function()
            {
                aj.post("index.php?m=zymanage&c=studyPlan&a=editSPManage&pc_hash=<?php echo $_GET["pc_hash"]?>",{titlename:this.titlename, VFTID:this.VFTID, FID:this.fileKeys, VID:this.videoKeys, SPID:this.SPID,  iselite:this.iselite, category:this.category, SCID:this.singleChoiceKeys,RCID:this.rankChoiceKeys, MCID:this.multipleChoiceKeys , TFCID:this.trueorfalseChoiceKeys},function(data){
                    if(data.code == 1)
                    {
