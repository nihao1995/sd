...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#typename").formValidator({empty:false,onshow:"不能为空。"}).inputValidator({min:2,max:20,onerror:"名称应该为2-20位之间"}).ajaxValidator({
        type : "get",
        url : "",
...
<form name="myform" id="myform" action="?m=zymanage&c=studyPlan&a=addManageType" method="post"  onsubmit="return pushData()">
<div class="pad-10">
		...
		<table width="100%" class="table_form">
			<tbody>
				<tr> 
					...
					<td><input required type="text" name="typename" value="" class="input-text" id="typename" size="15"></td>
				</tr>
                <tr> 
					<th>是否显示到导航</th>
                ...
                <tr>
                    <th>排序</th>
                    <td><input required type="text" name="sort" value="100" class="input-text" id="typename" size="15"></td>
                </tr>
                <tr>
