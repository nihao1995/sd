...
<script>
    var layer = layui.layer,
        ...
        upload = layui.upload,
        table = layui.table;
    aj.post("index.php?m=zymanage&c=slideshowMange&a=getTypeData&pc_hash=<?php echo $_GET["pc_hash"]?>",{},function(data){
        if(data.code=='1')
        {
            console.log(data);
            app = new Vue({
                ...
                methods:{
                    ...
                    del:function(SSID){
                        ...
                        layer.confirm('确定删除？', {icon: 3, title:'提示'}, function(index) {
                            aj.post("index.php?m=zymanage&c=slideshowMange&a=delType&pc_hash=<?php echo $_GET["pc_hash"]?>", {SSID: SSID}, function (data) {
                                that.refresh();
                            })
                        })
                    },
                    edit:function(SSID){
                        ...
                        layer.open({
                            ...
                            shade: 0.8,
                            area: ['500px', '50%'],
                            content: 'index.php?m=zymanage&c=slideshowMange&a=editSlideshow&pc_hash=<?php echo $_GET["pc_hash"]?>&SSID='+SSID, //iframe的url
                            end: function () {
                                console.log(1);
                                that.refresh();
                            }
                    ...
                    addType:function(){
                        ...
                        layer.open({
                            ...
                            shade: 0.8,
                            area: ['500px', '50%'],
                            content: 'index.php?m=zymanage&c=slideshowMange&a=addSlideshow&pc_hash=<?php echo $_GET["pc_hash"]?>', //iframe的url
                            end: function () {
                                console.log(1);
                                that.refresh();
                            }
