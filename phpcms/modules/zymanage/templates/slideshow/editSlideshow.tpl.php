...
<form name="myform" id="myform" action="?m=zymanage&c=slideshowMange&a=editSlideshow" method="post"  onsubmit="return pushData()">
<input type="hidden" name="SSID" value="<?php echo $data['SSID']?>" class="input-text">
<div class="pad-10">
			...
			<tbody>
				<tr>
                    ...
                    <td>
                        <div style="width: 161px; text-align: center;">
                            <div class='upload-pic img-wrap'><input type='hidden' name='thumb' id='thumb' required="" value=<?php echo $data["photo"]?>>
                ...
                <tr> 
                    ...
                    <td><select name="isshow">
                            <option value="0" <?php if($data["isshow"] == "0") echo "selected"?>>不显示</option>
                            <option value="1" <?php if($data["isshow"] == "1") echo "selected"?>>显示</option>
                    </select></td>
				</tr>
			</tbody>
		</table>
