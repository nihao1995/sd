...
<form name="myform" id="myform" action="?m=zymanage&c=rules&a=editRulesManage" method="post" onsubmit="return zz()">
            ...
            <fieldset>
                ...
                <table  class="table_form">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea  required name="titlename" id="" cols="70" rows="2" maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)"><?php echo $data["titlename"]?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th style="width: 120px">摘要</th>
                        <td>
                            <textarea  required name="abstract" id="" cols="70" rows="2" maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)"><?php echo $data["abstract"]?></textarea>
                        </td>
                    </tr>
                    <tr>
...
<script>
    ...
    var str = '<?php echo $data["editorValue"]?>';
