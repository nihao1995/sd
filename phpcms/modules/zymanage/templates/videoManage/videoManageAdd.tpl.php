...
<form name="myform" id="myform" action="?m=zymanage&c=videoManage&a=addVideoManage" method="post" onsubmit="pushData()">
    <div class="pad-10">
                ...
                <fieldset>
                    ...
                    <table  class="table_form">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea  required name="info[titlename]" id="" cols="70" rows="2" maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th style="width: 120px">视频内容</th>
                            <td>
                                <textarea required name="info[content]" id="" cols="70" rows="3 " maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)"></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="app">
                            ...
                            <th>
                                <Upload :format="['mp4', 'AVI']" :on-format-error="format" :max-size="20480" :before-upload="Bupload"  :on-exceeded-size="exceeded" :default-file-list="uploadList"  :on-success="success" :on-remove="remove" action="index.php?m=zymanage&c=fileManage&a=upFile&pc_hash=<?php echo $_GET["pc_hash"]?>" >
                        ...
                        <tr>
                            ...
                            <select name="info[VFTID]">
                                <?php foreach($category as $key=>$value){?>
                                    <option value=<?php echo $value["VFTID"]?> ><?php echo $value["typename"]?></option>
                                <?php }?>
                            </select>
                            </th>
                        </tr>
