    ...
    window.parent.app12 = new Vue({
        ...
        methods:{
            upload:function()
            {
                ...
                aj.post("index.php?m=zysd&c=zysd&a=add_noticeType&pc_hash=<?php echo $_GET["pc_hash"]?>",{notice_type_name:this.notice_type_name, sort:this.sort,status:this.status},function(data){
                    if(data.code == 200)
                    {
