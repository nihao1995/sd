...
<script>
    ...
    aj.post("index.php?m=zysd&c=zysd&a=fund_records&pc_hash=<?php echo $_GET["pc_hash"]?>",{fund_type:1,type:2,page:'1'},function(data){
        if(data.code=='200')
        {
            app = new Vue({
                el: '#singleChoice',
                ...
                methods:{
                    ...
                    getData:function(page){
                        ...
                        aj.post("index.php?m=zysd&c=zysd&a=fund_records&pc_hash=<?php echo $_GET["pc_hash"]?>",{fund_type:1,type:2, page:page, userid:this.userid, time:this.time},function(data){
                            console.log(data);
                            that.page = page;
