...
<script>
    ...
    window.parent.app12 = new Vue({
        ...
        methods:{
            upload:function()
            {
                aj.post("index.php?m=zysd&c=zysd&a=add_bankcard&pc_hash=<?php echo $_GET["pc_hash"]?>",{userid:this.userid, bank_name:this.bank_name,bank_cardid:this.bank_cardid, owner_name:this.owner_name , bank_branch:this.bank_branch},function(data){
                    if(data.code == 200)
                    {
