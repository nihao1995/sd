...
<input type="hidden" value="agent_manage" name="a">
...
<select name="product_types">
    ...
    <?php foreach($loanstype as $zz){?>
        <option value="<?php echo $zz['language']?>" <?php if ($_GET['product_types']=='<?php echo $zz["language"]?>') {?>selected<?php }?>><?php echo $zz['language']?></option>
    <?php }?>
...
<div class="explain-col search-form">
    <div style="margin-bottom: 5px;">
        <a href="?m=zymember&c=member&a=agent_manage&fenxiao=1" class="btn" style="margin-right: 10px;">按累计客户排名</a>
        <a href="?m=zymember&c=member&a=agent_manage&fenxiao=2" class="btn">按累计收益排名</a>
    </div>
</div>
...
if(is_array($info)){
	...
	<tr <?php if($info['audit']==4){?> style="text-decoration: line-through; color: #999;"<?php } ?>>
        ...
        <td align="center">
            ...
            <a href="?m=zymember&c=member&a=member_team&userid=<?php echo $info['userid']?>" class="btn btn-sm btn-info" style="padding-top: 0;padding-bottom: 0;">[我的团队]</a>
